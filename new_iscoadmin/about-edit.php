    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="registration/about.php" method="POST">
                    <div class="input-group mb-3 w-50 ml-auto mr-auto">
                        ...
                        <input type="text" name="about_title" id="inputGroupSelect01" class="form-control " value="<?=$about_title ?>" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                    </div>
                <textarea id="editor" class="ckeditor"  name="about">
                <?=$about; ?>
                </textarea>
                    <br>
                    <div class="container-fluid text-center">
                    <button class="btn btn-success btn-icon-split w-50">
